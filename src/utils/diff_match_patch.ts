...
/**
 * 包含diff、match和patch方法的类。
 * @constructor
 */
 const diff_match_patch = function diff_match_patch (this: any) {
...
diff_match_patch.prototype.diff_cleanupSemantic = function(diffs) {
  var changes = false;
  var equalities: number[] = [];  // Stack of indices where equalities are found.
  var equalitiesLength = 0;  // Keeping our own length var is faster in JS.
  /** @type {?string} */
  var lastEquality: any[] | null = null;
...
diff_match_patch.prototype.patch_fromText = function(textline) {
  ...
  while (textPointer < text.length) {
    ...
    while (textPointer < text.length) {
      ...
      try {
        var line: string = decodeURI(text[textPointer].substring(1));
      } catch (ex) {
        // Malformed URI sequence.
 ...
 * @constructor
 */
diff_match_patch.patch_obj = function(this: any) {
