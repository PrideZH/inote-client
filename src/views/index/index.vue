...
<template>
  ...
  <div class="note-container">
    ...
    <div class="note-main">
      <div
        v-show="noteStore.currentNote !== null"
        id="editor"
        :class="appStore.isMobile ? 'editor-mobile' : 'editor-pc'"
        @keydown.ctrl.s.prevent="noteStore.saveCurrentNote()"
      />
